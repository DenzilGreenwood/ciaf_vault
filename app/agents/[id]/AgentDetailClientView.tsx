...
interface AgentDetailClientViewProps {
  agent: AgentIdentity
  stats: {
  ...
  activeGrants: ElevationGrant[]
  violations: AgentAction[]
}

export default function AgentDetailClientView({
  agent,
  stats,
  recentActions,
  activeGrants,
  violations
}: AgentDetailClientViewProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          ...
          <div className="mt-2 text-3xl font-bold text-gray-900 dark:text-white">{stats.total_actions}</div>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="text-sm font-medium text-gray-500 dark:text-gray-400">Allowed</div>
          <div className="mt-2 text-3xl font-bold text-green-600 dark:text-green-400">{stats.actions_allowed}</div>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="text-sm font-medium text-gray-500 dark:text-gray-400">Denied</div>
          <div className="mt-2 text-3xl font-bold text-red-600 dark:text-red-400">{stats.actions_denied}</div>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="text-sm font-medium text-gray-500 dark:text-gray-400">Active Grants</div>
          <div className="mt-2 text-3xl font-bold text-yellow-600 dark:text-yellow-400">{stats.active_grants}</div>
        </div>
      </div>
